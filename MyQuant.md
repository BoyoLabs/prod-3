...
**2. SUGGESTION (lead with it, one line)** — State it in this committed format: `SUGGESTION: [TICKER] LONG — Grade [A/B/C] ([n]/5)` — followed by the *entry trigger condition* (not a preset price).
